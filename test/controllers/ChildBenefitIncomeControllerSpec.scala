...
class ChildBenefitIncomeControllerSpec extends SpecBase with MockitoSugar {

  def onwardRoute = Call("GET", "/foo")

  val formProvider = new ChildBenefitIncomeFormProvider()
  ...
  "ChildBenefitIncome Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(mtdItId, taxYear).set(ChildBenefitIncomePage, true).success.value
