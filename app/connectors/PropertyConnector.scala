...
@Singleton
class PropertyConnector @Inject()(config: FrontendAppConfig, httpClient: HttpClientV2)
  ...
  def getPrePopulation(nino: String, taxYear: Int, mtdItId:String)
    ...
    val prePopulationUrl: URL = url"${config.propertyBaseUrl}/property/pre-population/$nino"
    ...
    httpClient
      ...
      .execute[HttpResult[PropertyPrePopulationResponse]]
  }
}
