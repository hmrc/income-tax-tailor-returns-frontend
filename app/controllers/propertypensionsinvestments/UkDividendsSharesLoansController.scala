...
class UkDividendsSharesLoansController @Inject()(
                                        ...
                                        formProvider: UkDividendsSharesLoansFormProvider,
                                        val controllerComponents: MessagesControllerComponents,
                                        view: UkDividendsSharesLoansView,
                                        agentView: UkDividendsSharesLoansAgentView
  ...
  def onPageLoad(mode: Mode, taxYear: Int): Action[AnyContent] =
    ...
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(UkDividendsSharesLoansPage) match {
