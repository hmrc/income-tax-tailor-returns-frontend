...
class UkResidenceStatusController @Inject()(
                                             ...
                                             formProvider: UkResidenceStatusFormProvider,
                                             val controllerComponents: MessagesControllerComponents,
                                             view: UkResidenceStatusView,
                                             agentView: UkResidenceStatusAgentView
  ...
  def onSubmit(mode: Mode, taxYear: Int): Action[AnyContent] = (identify(taxYear) andThen taxYearAction(taxYear) andThen taxYearAction(taxYear) andThen getData(taxYear)).async {
    implicit request =>
