...
sealed trait NonUkInterestDividendsInsurance

object NonUkInterestDividendsInsurance extends Enumerable.Implicits {

  case object Option1 extends WithName("option1") with NonUkInterestDividendsInsurance
  case object Option2 extends WithName("option2") with NonUkInterestDividendsInsurance
  case object ExclusiveOption extends WithName("exclusive") with NonUkInterestDividendsInsurance

  val values: Seq[NonUkInterestDividendsInsurance] = Seq(
    Option1,
    Option2,
    ExclusiveOption
  )
