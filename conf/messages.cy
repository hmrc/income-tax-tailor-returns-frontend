...
pensions.details.understandingUnauthorisedPayments.p2.linkText = Learn more about unauthorised payments from pension schemes (opens in a new tab)
...
pensions.error.required = Select if you got any income from pensions
pensions.agent.error.required = Select if your client got any income from pensions
